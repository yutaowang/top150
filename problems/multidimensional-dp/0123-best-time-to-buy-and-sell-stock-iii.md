...
Solve LeetCode #123 (Best Time to Buy and Sell Stock III). This file gives a concise paraphrase of the task and focuses on the algorithm, implementation, and test strategy.
