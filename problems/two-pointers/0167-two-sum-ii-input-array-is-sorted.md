...
Solve LeetCode #167 (Two Sum II - Input Array Is Sorted). This file gives a concise paraphrase of the task and focuses on the algorithm, implementation, and test strategy.
