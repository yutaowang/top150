...
- **Difficulty:** Medium
- **Category:** Heap
- **Tags:** Divide and Conquer, Sorting, Array

## 1. 题目描述

Solve LeetCode #215 (Kth Largest Element in an Array). This file gives a concise paraphrase of the task and focuses on the algorithm, implementation, and test strategy.
