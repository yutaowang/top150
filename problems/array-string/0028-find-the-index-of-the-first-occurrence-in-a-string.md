...
- **Tags:** String Matching, Two Pointers, String

## 1. 题目描述

Solve LeetCode #28 (Find the Index of the First Occurrence in a String). This file gives a concise paraphrase of the task and focuses on the algorithm, implementation, and test strategy.
