...
Solve LeetCode #117 (Populating Next Right Pointers in Each Node II). This file gives a concise paraphrase of the task and focuses on the algorithm, implementation, and test strategy.
