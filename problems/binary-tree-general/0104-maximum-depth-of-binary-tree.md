...
Solve LeetCode #104 (Maximum Depth of Binary Tree). This file gives a concise paraphrase of the task and focuses on the algorithm, implementation, and test strategy.
