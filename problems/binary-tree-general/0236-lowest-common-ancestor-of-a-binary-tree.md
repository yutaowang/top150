...
Solve LeetCode #236 (Lowest Common Ancestor of a Binary Tree). This file gives a concise paraphrase of the task and focuses on the algorithm, implementation, and test strategy.
