...
Solve LeetCode #114 (Flatten Binary Tree to Linked List). This file gives a concise paraphrase of the task and focuses on the algorithm, implementation, and test strategy.
