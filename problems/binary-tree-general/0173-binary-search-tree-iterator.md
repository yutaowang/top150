...
Solve LeetCode #173 (Binary Search Tree Iterator). This file gives a concise paraphrase of the task and focuses on the algorithm, implementation, and test strategy.
