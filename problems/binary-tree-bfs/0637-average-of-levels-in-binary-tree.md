...
Solve LeetCode #637 (Average of Levels in Binary Tree). This file gives a concise paraphrase of the task and focuses on the algorithm, implementation, and test strategy.
