...
Solve LeetCode #128 (Longest Consecutive Sequence). This file gives a concise paraphrase of the task and focuses on the algorithm, implementation, and test strategy.
